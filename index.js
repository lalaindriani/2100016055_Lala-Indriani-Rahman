 ...
 * Alasan perubahan return arr.filter((num) => num % 2 !== 0).toString();to return arr.filter((num) => num % 2 === 0);
 * adalah untuk memastikan bahwa fungsi mengembalikan array yang difilter secara langsung, alih-alih mengubahnya menjadi string.
 */
